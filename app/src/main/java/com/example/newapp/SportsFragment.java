...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView= (RecyclerView) v.findViewById(R.id.RecyclerViewSports);
    ...
    public void search() {
        String url = "https://newsdata.io/api/1/news?apikey=pub_379917531ca0f1f05882da2ac943385d6d39&country=in&category=sports";
