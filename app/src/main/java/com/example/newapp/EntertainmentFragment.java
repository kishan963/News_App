...
public class EntertainmentFragment extends Fragment {
 ...
 private RecyclerView recyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        search();
        recyclerView= (RecyclerView) v.findViewById(R.id.RecyclerViewEntertainment);
    ...
    public void search() {
        String url = "https://newsdata.io/api/1/news?apikey=pub_379917531ca0f1f05882da2ac943385d6d39&country=in&category=entertainment";
